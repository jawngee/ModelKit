...
#import "COTC0002ModelTestCases.h"
#import "TestModel.h"

@implementation COTC0002ModelTestCases
...
-(void)test001SerializeDeserialize
{
    ...
    m2.amodelArrayV=[COMutableModelArray arrayWithArray:@[m3,m4]];
    m2.amodelV=m1;
    
    m3.amodelArrayV=[COMutableModelArray arrayWithArray:@[m1,m2]];
    m3.amodelV=m2;
    
    m4.amodelArrayV=[COMutableModelArray arrayWithArray:@[m1,m2]];
    m4.amodelV=m3;
    ...
    [COModelContext clearAllContexts];
    m1=(TestModel *)[[COModelContext current] modelForId:@"001" andClass:[TestModel class]];
    ...
    STAssertTrue([COModelContext current].contextCount==4, @"Context count mismatch, should be 4.");
