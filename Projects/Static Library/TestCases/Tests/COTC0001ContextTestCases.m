...
- (void)test0001ContextSize
{
    ...
    STAssertTrue([COModelContext current].contextSize==80, @"Contexts size mismatch.");
    STAssertTrue([COModelContext current].contextCount==1, @"Contexts count mismatch.");
    
    [model removeFromContext];
    
    STAssertTrue([COModelContext current].contextSize==0, @"Contexts size mismatch.");
    STAssertTrue([COModelContext current].contextCount==0, @"Contexts count mismatch.");
}
...
{
    COModelContext *context=[[COModelContext alloc] init];
...
-(void)test0004FindModel
{
    ...
    TestModel *m2=(TestModel *)[[COModelContext current] modelForId:@"hey" andClass:[TestModel class]];
    STAssertTrue(m==m2, @"Objects do not match");
    
    m2=[TestModel instanceWithId:@"hey"];
    STAssertTrue(m==m2, @"Objects do not match");
    
    [[COModelContext current] clear];
    m2=(TestModel *)[[COModelContext current] modelForId:@"hey" andClass:[TestModel class]];
...
-(void)test0005SaveContext
{
    ...
    STAssertTrue([[COModelContext current] saveToFile:@"/tmp/persist.plist" error:nil], @"This should never fail.");
    
    [COModelContext clearAllContexts];
}
...
-(void)test0006LoadContext
{
    ...
    STAssertTrue([[COModelContext current] loadFromFile:@"/tmp/persist.plist" error:nil], @"This should never fail either.");
    
    TestModel *m=(TestModel *)[[COModelContext current] modelForId:@"004" andClass:[TestModel class]];
...
-(void)test0007ComplicatedSaveLoad
{
    ...
    m1.floatV=0.66f;
    m1.doubleV=10.233;
    m1.amodelArrayV=[COMutableModelArray arrayWithArray:@[m2,m3]];
    m1.amodelV=m5;
    ...
    m2.floatV=0.66f;
    m2.doubleV=10.233;
    m2.amodelArrayV=[COMutableModelArray arrayWithArray:@[m1,m6]];
    m2.amodelV=m3;
    ...
    m3.floatV=0.66f;
    m3.doubleV=10.233;
    m3.amodelArrayV=[COMutableModelArray arrayWithArray:@[m1,m2]];
    m3.amodelV=m4;
    ...
    m4.floatV=0.66f;
    m4.doubleV=10.233;
    m4.amodelArrayV=[COMutableModelArray arrayWithArray:@[m1,m2,m3]];
    m4.amodelV=m6;
    ...
    m5.floatV=0.66f;
    m5.doubleV=10.233;
    m5.amodelArrayV=[COMutableModelArray arrayWithArray:@[m2,m3]];
    m5.amodelV=m1;
    ...
    m6.floatV=0.66f;
    m6.doubleV=10.233;
    m6.amodelArrayV=[COMutableModelArray arrayWithArray:@[m4,m5]];
    m6.amodelV=m3;

    STAssertTrue([[COModelContext current] saveToFile:@"/tmp/persist.plist" error:nil]==YES,@"This should never fail.");
    [COModelContext clearAllContexts];
    STAssertTrue([[COModelContext current] loadFromFile:@"/tmp/persist.plist" error:nil]==YES,@"This should never fail.");
